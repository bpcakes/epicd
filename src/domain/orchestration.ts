...
export const KernelActionSchema = z.discriminatedUnion("kind", [
  ...
  z.strictObject({
    kind: z.literal("inspect_record"),
    ...JournalRecordTargetSchema.shape,
    offset: Version,
  ...
  z.strictObject({ kind: z.literal("inspect_fixture_access"), accessId: Id }),
  z.strictObject({ kind: z.literal("reconcile_fixture_access"), accessId: Id }),
  z.strictObject({
  ...
  z.strictObject({ kind: z.literal("inspect_tracker_operation"), trackerOperationId: Id }),
  z.strictObject({
    kind: z.literal("read_tracker_issue"),
    snapshotId: Id,
    taskId: Id,
    field: z.enum([
      "description",
    ...
    offset: Version,
    limit: z.number().int().min(1).max(16000),
  }),
  z.strictObject({ kind: z.literal("reconcile_tracker_operation"), trackerOperationId: Id }),
  z.strictObject({
